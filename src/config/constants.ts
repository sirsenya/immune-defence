...
export const ACTIONS: Record<'summons' | 'docs' | 'detain' | 'neighbors' | 'medical', import('./../game/types/game').ActionDef> = {
  summons: {
    id: 'summons',
    label: 'ПОВЕСТКА',
...
export const NAMES_FIRST = [
  'Иван', 'Пётр', 'Сергей', 'Андрей', 'Михаил', 'Алексей', 'Дмитрий',
  'Ольга', 'Елена', 'Татьяна', 'Наталья', 'Ирина', 'Светлана', 'Мария',
  'Анна', 'Юлия', 'Виктор', 'Николай', 'Артём', 'Кирилл', 'Павел', 'Роман',
];
...
export const PROFESSIONS = [
  'Токарь', 'Сварщик', 'Учитель', 'Водитель', 'Программист', 'Бухгалтер',
  'Врач', 'Строитель', 'Электрик', 'Продавец', 'Инженер', 'Слесарь',
  'Каменщик', 'Оператор', 'Курьер', 'Охранник', 'Машинист', 'Грузчик',
  'Фермер', 'Таксист', 'Повар', 'Журналист', 'Музыкант', 'Художник',
];
